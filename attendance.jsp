        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE ATTENDANCE SET END_QUARTER = ?, END_YEAR = ? " +
                        ...
                        pstmt.setString(4, request.getParameter("START_YEAR"));
                        pstmt.setInt(
                            5, Integer.parseInt(request.getParameter("STUDENT_ID")));
                        int rowCount = pstmt.executeUpdate();
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM ATTENDANCE WHERE STUDENT_ID = ? AND START_QUARTER = ? " +
                            " AND START_YEAR = ?");
