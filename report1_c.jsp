    ...
    <table border="3">
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("search")) {
                        ...
                        PreparedStatement pstmt3 = conn.prepareStatement(
                            "SELECT S.ID AS ID, S.FIRSTNAME AS FIRSTNAME, S.MIDDLENAME AS MIDDLENAME, S.LASTNAME AS LASTNAME FROM STUDENT S WHERE S.ID = ?");
                        ...
                        PreparedStatement pstmt2 = conn.prepareStatement(
                            "SELECT S.QUARTER AS QUARTER, S.YEAR AS YEAR, SUM(GC.NUMBER_GRADE)/COUNT(*) AS GPA FROM TAKEN T, STUDENT ST, GRADE_CONVERSION GC, SECTION S WHERE ST.ID = ? AND ST.ID = T.STUDENT_ID AND T.GRADE = GC.LETTER_GRADE AND T.SECTION_ID = S.SECTION_ID GROUP BY S.QUARTER, S.YEAR");
                        ...
                        PreparedStatement pstmt4 = conn.prepareStatement(
                            "SELECT SUM(GC.NUMBER_GRADE)/COUNT(*) AS GPA FROM TAKEN T, STUDENT ST, GRADE_CONVERSION GC WHERE ST.ID = ? AND ST.ID = T.STUDENT_ID AND T.GRADE = GC.LETTER_GRADE GROUP BY T.STUDENT_ID");
                        pstmt4.setInt(1, Integer.parseInt(request.getParameter("ID")));
            ...
            <%
                ...
                student = statement2.executeQuery("SELECT S.ID AS ID, S.FIRSTNAME AS FIRSTNAME, S.MIDDLENAME AS MIDDLENAME, S.LASTNAME AS LASTNAME FROM STUDENT S");
                        ...
                        <form action="report1_c.jsp" method="get">
                            ...
                            <select name = "ID">
                                <% 
                                    while ( student.next() ){
                                %>
                                     <option value="<%= student.getString("ID") %>"><%= student.getString("ID") %> | <%= student.getString("FIRSTNAME") %>, <%=student.getString("LASTNAME") %></option>
                                <%
                                    }
                                %>
